...
**Required workflow:**
1. Upload assets to a cloud storage provider (like AWS S3 or Cloudinary).
2. Use the returned storage path directly in your code.
...
**CRITICAL: Use Google Maps features as needed** - including advanced drawing, heatmaps, Street View, all layers, Places API, etc.
...
NEVER request API keys from users in the UI - handle authentication securely.
